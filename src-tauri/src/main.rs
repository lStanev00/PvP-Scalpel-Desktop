...
fn main() {
    const FORCE_SPELL_DUMP: bool = true;
    let cli_spell_dump = std::env::args().any(|arg| arg == "--spell-dump");
    ...
    .setup(move |app| {
            ...
            crate::casc_storage::bootstrap::spawn_from_account_path(
                handle.clone(),
                account_path.clone(),
                crate::casc_storage::bootstrap::CascBootstrapOptions {
                    run_spell_dump: cli_spell_dump || FORCE_SPELL_DUMP,
                },
            );
